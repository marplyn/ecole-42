...
static char	*ft_read_before_newline(int fd, char *leftover)
{
	char	*buff;
	int		read_bytes;
...
static char	*ft_line_from_leftover(char *leftover)
{
	int		i;
	char	*line;
...
static char	*ft_trim_leftover(char *leftover)
{
	int		i;
	int		j;
	char	*new_leftover;
	...
	new_leftover = (char *)malloc(sizeof(char)
